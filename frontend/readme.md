Travelopia-Assignment Description This repository contains the codebase for the Travelopia-Assignment webpage, which includes both the frontend and backend components.
